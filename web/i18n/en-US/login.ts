const translation = {
  ...
  welcome: 'Welcome to IThena, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting IThena Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on IThena',
  invalid: 'The link has expired',
  explore: 'Explore IThena',
